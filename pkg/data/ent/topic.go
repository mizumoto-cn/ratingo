...
func (e TopicEdges) AnalysisOrErr() (*Analysis, error) {
	if e.loadedTypes[0] {
		if e.Analysis == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: analysis.Label}
		}
...
func (e TopicEdges) RatingsOrErr() ([]*Rating, error) {
	if e.loadedTypes[1] {
...
// QueryAnalysis queries the "analysis" edge of the Topic entity.
func (t *Topic) QueryAnalysis() *AnalysisQuery {
	return (&TopicClient{config: t.config}).QueryAnalysis(t)
}

// QueryRatings queries the "ratings" edge of the Topic entity.
func (t *Topic) QueryRatings() *RatingQuery {
	return (&TopicClient{config: t.config}).QueryRatings(t)
}
...
func (t *Topic) String() string {
	...
	builder.WriteString(t.TopicName)
	builder.WriteByte(')')
